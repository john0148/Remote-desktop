...
protected:
	void ServerScreen(std::shared_ptr<olc::net::connection<CustomMsgTypes>> client)
	{

		imageSendingThread = std::thread([this](std::shared_ptr<olc::net::connection<CustomMsgTypes>> client){
            while (imageSending) {
